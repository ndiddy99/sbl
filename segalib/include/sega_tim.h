...
/**** CPU (ﾌﾘｰﾗﾝﾆﾝｸﾞﾀｲﾏ) *****************************************************/
/******** レジスタ ***********************************************************/
#define TIM_REG_TIER    ((Uint8  *)0xfffffe10)          /* ﾀｲﾏｲﾝﾀﾗﾌﾟﾄｲﾈｰﾌﾞﾙ  */
#define TIM_REG_TCSR    ((Uint8  *)0xfffffe11)          /* ﾀｲﾏｺﾝﾄﾛｰﾙ･ｽﾃｰﾀｽ   */
#define TIM_REG_FRC_H   ((Uint8  *)0xfffffe12)          /* ﾌﾘｰﾗﾝﾆﾝｸﾞｶｳﾝﾀ H   */
#define TIM_REG_FRC_L   ((Uint8  *)0xfffffe13)          /* ﾌﾘｰﾗﾝﾆﾝｸﾞｶｳﾝﾀ L   */
#define TIM_REG_OCRX_H  ((Uint8  *)0xfffffe14)          /* ｱｳﾄﾌﾟｯﾄｺﾝﾍﾟｱA,B H */
#define TIM_REG_OCRX_L  ((Uint8  *)0xfffffe15)          /* ｱｳﾄﾌﾟｯﾄｺﾝﾍﾟｱA,B L */
#define TIM_REG_TCR     ((Uint8  *)0xfffffe16)          /* ﾀｲﾏｺﾝﾄﾛｰﾙ　　　   */
#define TIM_REG_TOCR    ((Uint8  *)0xfffffe17)          /* ﾀｲﾏｱｳﾄﾌﾟｯﾄｺﾝﾍﾟｱ   */
#define TIM_REG_ICRA_H  ((Uint8  *)0xfffffe18)          /* ｲﾝﾌﾟｯﾄｷｬﾌﾟﾁｬA H   */
#define TIM_REG_ICRA_L  ((Uint8  *)0xfffffe19)          /* ｲﾝﾌﾟｯﾄｷｬﾌﾟﾁｬA L   */
/******** 定数 ***************************************************************/
/************ ビット位置 *****************************************************/
/**************** ﾀｲﾏｲﾝﾀﾗﾌﾟﾄｲﾈｰﾌﾞ  *******************************************/
